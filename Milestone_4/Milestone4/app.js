...
mongoose.connect("mongodb://localhost/Milestone4", { useFindAndModify: false, useNewUrlParser: true, useUnifiedTopology: true});
...
let del = require('./controller/delete.js');
...
app.use('/new_connection',newConnection)
